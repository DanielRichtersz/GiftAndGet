...
public class RegisterClientFrame extends JFrame {
    ...
    private RegisterClientRestGateway registerClientRestGateway = new RegisterClientRestGateway();
    ...
    private void registerNewUserForm() {
        //-------------REGISTER NEW USER
        emailTextfield();
        usernameTextfield();
        passwordTextfield();
        ...
        btn_RegisterUser.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                ...
                if (!tf_registerEmail.getText().isEmpty() ||
                    ...
                    String response = registerClientRestGateway.RegisterNewUser(
